...
module.exports = function (e) {
    ...
    if (a && s && o) {
      ...
      var b = new t.ShaderMaterial({
          uniforms: {
            ...
            disp: { type: "t", value: E },
            res: { type: "vec4", value: new t.Vector4(r.offsetWidth, r.offsetHeight, W, V) },
        ...
        _ = new t.Mesh(D, b);
      F.add(_),
        g && (r.addEventListener("mouseenter", z), r.addEventListener("touchstart", z), r.addEventListener("mouseleave", S), r.addEventListener("touchend", S)),
        window.addEventListener("resize", function (e) {
          r.offsetHeight / r.offsetWidth < R ? ((W = 1), (V = r.offsetHeight / r.offsetWidth / R)) : ((W = (r.offsetWidth / r.offsetHeight) * R), (V = 1)),
            (_.material.uniforms.res.value = new t.Vector4(r.offsetWidth, r.offsetHeight, W, V)),
  ...
  function z() {
    i.to(b.uniforms.dispFactor, c, { value: 1, ease: h, onUpdate: L, onComplete: L });
  }
  function S() {
    i.to(b.uniforms.dispFactor, p, { value: 0, ease: h, onUpdate: L, onComplete: L });
  }
};
