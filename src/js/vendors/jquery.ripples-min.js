...
!(function (e, t) {
  ...
  (c.DEFAULTS = { imageUrl: null, resolution: 256, dropRadius: 20, perturbance: 0.03, interactive: !0, crossOrigin: "" }),
    (c.prototype = {
      ...
      computeTextureBoundaries: function () {
        ...
        if (
          ("fixed" == o
            ? (((e = { left: window.pageXOffset, top: window.pageYOffset }).width = u.width()), (e.height = u.height()))
