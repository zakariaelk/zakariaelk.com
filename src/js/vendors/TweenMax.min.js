    ...
    function (a, b, c) {
      ...
      (f.version = "1.20.2"),
        ...
        (k.updateTo = function (a, b) {
          ...
          if (this._initted || f)
            if (b) (this._initted = !1), f && this.render(0, !0, !0);
              ...
              (this._gc && this._enabled(!0, !1), this._notifyPluginsOfEnabled && this._firstPT && c._onPluginEvent("_onDisable", this), this._time / this._duration > 0.998)
            ) {
        ...
        (f.staggerTo = f.allTo = function (a, b, g, h, k, m, n) {
          ...
          for (
            j(a) || ("string" == typeof a && (a = c.selector(a) || a), i(a) && (a = d(a))), a = a || [], 0 > h && ((a = d(a)), a.reverse(), (h *= -1)), o = a.length - 1, q = 0;
            o >= q;
            q++
          ) {
            p = {};
      ...
      function (a, b, c) {
        ...
        return (
          ...
          (q._parseTimeOrLabel = function (b, c, d, e) {
            ...
            if (((f = this.duration() > 99999999999 ? this.recent().endTime(!1) : this._duration), "string" == typeof c))
    ...
    if (!e.TweenLite) {
      ...
      (X._startTime = i.time),
        ...
        (D._updateRoot = G.render = function () {
          var a, b, c;
          if (
            (J.length && Z(), X.render((i.time - X._startTime) * X._timeScale, !1, !1), W.render((i.frame - W._startTime) * W._timeScale, !1, !1), J.length && Z(), i.frame >= Y)
          ) {
